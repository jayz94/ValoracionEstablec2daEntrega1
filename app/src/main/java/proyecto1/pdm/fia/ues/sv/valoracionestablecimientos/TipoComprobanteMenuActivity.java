...
public class TipoComprobanteMenuActivity extends ListActivity {

    String[] menu = {"Insertar Registro", "EliminarRegistro", "ConsultarRegistro", "Actualizar Registro"};
    String[] activities = {"TipoComprobanteInsertarActivity", "TipoComprobanteEliminarActivity", "TipoComprobanteConsultarActivity", "TipoComprobanteActualizarActivity"};
